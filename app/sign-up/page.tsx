...
export default function SignUpPage() {
  ...
  const content = {
    ...
    identifyDesc: t({ mn: "Сангхад бүртгүүлж, эртний мэргэн ухаантай холбогдоорой.", en: "Register to join the sangha and connect with ancient wisdom." }),
    loadingText: t({ mn: "Оюун санааг сэрээж байна...", en: "Awakening Spirits..." }),
